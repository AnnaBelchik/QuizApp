...
public class MainActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(MainActivity.this, "Пожалуйста, выберите вариант ответа", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    public void showQuestions() {
        ...
        if (questionCounter < questionTotalCount) {
            ...
            textViewQuestionCount.setText("Вопросы: " + questionCounter + "/" + questionTotalCount);
            ...
            Toast.makeText(this, "Викторина завершена", Toast.LENGTH_SHORT).show();
    ...
    private void checkSolution(int answerNr, RadioButton rbselected) {
        ...
        switch (currentQuestions.getAnswerNr()) {
            case 1:
                if (currentQuestions.getAnswerNr() == answerNr) {
                    correctAns++;
                    score += 10;
                    textViewScore.setText("Очки: " + String.valueOf(score));
        ...
        if (questionCounter == questionTotalCount) {
            buttonConfirmNext.setText("Подтвердить и завершить");
        }
    }
...
//    }
    ...
    private void finalResult() {
        ...
        resultData.putExtra("Счёт игрока", score);
        resultData.putExtra("Вопросы", questionTotalCount);
        resultData.putExtra("Верно", correctAns);
        resultData.putExtra("Неверно", wrongAns);
